...
const { queryDeviceConverter } = require('../utils/queryDeviceConverter');
...
async function reportState(event) {
  const gladysFeature = this.gladys.stateManager.get('deviceFeature', event.device_feature_selector);
