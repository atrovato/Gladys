...
const DEVICE_FEATURE_TYPES = {
  LIGHT: {
    ...
    POWER: 'power',
    POWER_ON_BUTTON: 'power-on-button',
    POWER_OFF_BUTTON: 'power-off-button',
    BRIGHTER_BUTTON: 'brighter-button',
    DIMMER_BUTTON: 'dimmer-button',
    RED_BUTTON: 'red-button',
    RED_LIGHT_BUTTON: 'red-light-button',
    ORANGE_DARK_BUTTON: 'orange-dark-button',
    ORANGE_BUTTON: 'orange-button',
    YELLOW_BUTTON: 'yellow-button',
    GREEN_BUTTON: 'green-button',
    LIME_BUTTON: 'lime-button',
    TEAL_BUTTON: 'teal-button',
    CYAN_BUTTON: 'cyan-button',
    AZURE_BUTTON: 'azure-button',
    BLUE_BUTTON: 'blue-button',
    NIGHT_BUTTON: 'night-button',
    INDIGO_BUTTON: 'indigo-button',
    PURPLE_BUTTON: 'purple-button',
    PINK_BUTTON: 'pink-button',
    WHITE_BUTTON: 'white-button',
    FLASH_BUTTON: 'flash-button',
    STROBE_BUTTON: 'strobe-button',
    FADE_BUTTON: 'fade-button',
    SMOOTH_BUTTON: 'smooth-button',
  },
  SENSOR: {
    DECIMAL: 'decimal',
    INTEGER: 'integer',
