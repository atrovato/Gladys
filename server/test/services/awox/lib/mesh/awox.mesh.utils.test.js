...
} = require('../../../../../services/awox/lib/mesh/awox.mesh.utils');

const { PARAMS: BLUETOOTH_PARAMS } = require('../../../../../services/bluetooth/lib/utils/bluetooth.constants');
...
describe('awox.mesh.utils.getDefaultCredentials', () => {
  it('Extract for remote', () => {
    const device = {
      external_id: 'bluetooth:112233445566',
      params: [
        {
          name: BLUETOOTH_PARAMS.MANUFACTURER,
          value: 'awox',
        },
        {
          name: PARAMS.MESH_USER,
    ...
    const credentials = getDefaultCredentials(device, true);
    const expected = {
      user: 'R-445566',
      password: '1234',
    };
  ...
  it('Extract for not remote (no mesh group)', () => {
    const device = {
      external_id: 'bluetooth:112233445566',
      params: [
        {
    ...
    const credentials = getDefaultCredentials(device, false);
    const expected = {
      user: 'meshName',
      password: '1234',
    };
