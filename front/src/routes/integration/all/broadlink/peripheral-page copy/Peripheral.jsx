        ...
        >
          <div class="card-header">
            <div class="card-title">
              {props.peripheral.type || <Text id="integration.broadlink.peripheral.noNameLabel" />}
            </div>
          ...
          <div class="card-body">
            <div class="form-group">
              ...
              <input id="ipAddress" type="text" class="form-control" disabled={true} value={props.peripheral.host} />
            </div>
